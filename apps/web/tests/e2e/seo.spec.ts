...
const launchRoutes: RouteExpectation[] = [
  ...
  { path: "/tools/", title: "Free Tools — SeoVista", description: "A growing library of free tools for GEO and SEO readiness. Eight instruments are live as previews: GEO Readiness Checker, Schema Checker, AI Crawler Checker, SERP Preview, Keyword Rank Checker, Attribution Trace, Render Parity Diff, and Schema Truth Check." },
