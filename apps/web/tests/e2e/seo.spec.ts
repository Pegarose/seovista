...
const launchRoutes: RouteExpectation[] = [
  ...
  { path: "/tools/", title: "Free Tools — SeoVista", description: "A growing library of free tools for GEO and SEO readiness. The GEO Readiness Checker, Schema Checker, AI Crawler Checker, and SERP Preview are linked as previews." },
