...
describe("CrewReportView", () => {
  it("renders all five guardrail labels as English badge chips with descriptions", () => {
  ...
  it("renders headings, lists and tables through the custom component map", () => {
    ...
    expect(html).toMatch(/<h2 class="[^"]*font-serif[^"]*"/);
  ...
  it("renders the header band with CrewAgency attribution, timestamp and AI disclaimer", () => {
    ...
    expect(html).toContain("CrewAgency multi-agent system · generated:");
    expect(html).toContain("This report was generated by AI.");
    expect(html).toContain("Simulation, Forecast, Missing Data, Decision Needed, and Calculated");
  });
});
