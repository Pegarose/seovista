...
export const services: Service[] = [
  service(
    ...
    "Improve your relevance for generative answers without guaranteed outcomes.",
    geoPage.body ?? "",
  ),
  service(
    "seo",
    ...
    "Crawlability, structure, content, and index health for sustainable visibility.",
    seoPage.body ?? "",
  ),
  service(
    "digital-authority",
    "/digital-authority/",
    "Digital Authority",
    "Earned visibility through editorial reputation and credible mentions.",
