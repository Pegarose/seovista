...
const initialState: SchemaTruthActionState = {
  status: "idle",
};
        ...
        <div className="p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">
              Schema Doğruluk Denetimi
            </h1>
            <p className="mt-2 text-sm text-gray-500">
              Yapılandırılmış veri (JSON-LD) içindeki her iddianın sayfanın görünür içeriğinde
              karşılığını kontrol eder. "Şemada söylediğin şeyleri okuyucu sayfada bulabiliyor mu?"
              — cevabını dürüstçe verir.
            </p>
          </div>
          ...
          <form action={formAction} className="space-y-6">
            ...
            <div className="pt-2">
              ...
              >
                {isPending ? "Denetleniyor..." : "Denetimi Başlat"}
              </button>
            </div>
          </form>
        </div>
