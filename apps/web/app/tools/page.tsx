...
const instruments: Instrument[] = [
  ...
  { id: "02", name: "Attribution Trace", status: "Planned", summary: "Maps a synthesized answer back to the sources a generative system likely drew from, and flags misattribution." },
  { id: "03", name: "Render Parity Diff", status: "Planned", summary: "Compares what a crawler sees against what a user sees, so gaps in server-rendered content surface before they hurt retrieval." },
  { id: "04", name: "Schema Truth Check", status: "Planned", summary: "Verifies that structured markup matches the visible page, with no claims in JSON-LD that a reader cannot find on the page itself." },
];
