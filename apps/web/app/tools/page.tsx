...
const instruments: Instrument[] = [
  ...
  { id: "07", name: "Schema Truth Check", status: "Planned", summary: "Verifies that structured markup matches the visible page, with no claims in JSON-LD that a reader cannot find on the page itself." },
];
