...
const instruments: Instrument[] = [
  ...
  { id: "06", name: "SERP Preview", status: "Preview", summary: "Google sonuç görünümünü pixel bazlı kısaltma uyarılarıyla önizler.", href: "/tools/serp-preview/" },
  ...
  { id: "08", name: "Schema Truth Check", status: "Planned", summary: "Verifies that structured markup matches the visible page, with no claims in JSON-LD that a reader cannot find on the page itself." },
];
