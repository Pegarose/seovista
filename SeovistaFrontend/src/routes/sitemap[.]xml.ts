...
const ENTRIES: readonly SitemapEntry[] = [
  ...
  { path: "/seo/", changefreq: "monthly", priority: "0.8" },
  { path: "/digital-authority/", changefreq: "monthly", priority: "0.8" },
  { path: "/tools/", changefreq: "monthly", priority: "0.6" },
  { path: "/tools/geo-readiness-checker/", changefreq: "monthly", priority: "0.5" },
