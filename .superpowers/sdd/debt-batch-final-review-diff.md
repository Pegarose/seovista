...
STAT:
 ...
 15 files changed, 630 insertions(+), 255 deletions(-)
...
@@ -196,24 +196,38 @@ describe("buildCrewReportRequest", () => {
         scores: { overall: 42 },
...
@@ -18,21 +19,21 @@ export type AdminBootstrapIdentity = Pick<AdminBootstrapResult, "id"> &
...
@@ -114,21 +115,21 @@ export async function runLocalAdminBootstrap(
...
+      logger(`Admin ${adminEmail} already exists. Skipping.`);
     ...
     const insights = [
       ...
       {
@@ -66,56 +67,56 @@ async function main() {
...
-  type RobotsTxtDocument,
 ...
 export interface AiCrawlerAuditResultPayload {
   ...
   readonly crawlers: ReadonlyArray<{
     userAgent: string;
@@ -23,58 +23,29 @@ export interface AiCrawlerAuditResultPayload {
...
@@ -84,21 +84,23 @@ export interface CrewReportRequest {
...
@@ -73,165 +73,191 @@ export function getCrewReportWorkerConcurrency(options?: CrewReportWorkerOptions
...
+      );
   ...
   return worker;
@@ -241,34 +267,36 @@ export function startCrewReportWorker(options?: CrewReportWorkerOptions) {
...
@@ -2,30 +2,33 @@ import * as cheerio from "cheerio";
...
+  logger?: Logger;
  ...
  */
@@ -684,27 +687,28 @@ export async function fetchAndParseUrl(
...
@@ -738,21 +742,21 @@ export async function fetchAndParseUrlWithMeta(
       })
     );
   } else {
...
+  detectContradictoryRuleConflicts,
 ...
 Disallow: /admin
 Allow: /admin/public
@@ -65,10 +66,101 @@ describe("detectRuleConflicts", () => {
...
@@ -124,33 +124,44 @@ export function evaluateCrawlerAccess(doc: RobotsTxtDocument, userAgent: string)
